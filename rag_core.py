...
class LLMService:
    ...
    def _format_context(self, context_docs: List[Dict[str, Any]]) -> str:
        ...
        for i, doc_info in enumerate(context_docs):
            ...
            score_info = f" (Счет реранка: {doc_info.get('relevance_score', 'N/A'):.3f})" if 'relevance_score' in doc_info else f" (FAISS Sim: {doc_info['similarity']:.3f})"
...
class RAGCore:
    """Ядро RAG системы - поиск и ранжирование документов с использованием FAISS и реранкера"""
